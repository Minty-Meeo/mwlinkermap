...
constexpr std::string_view SMToSV(const std::pair<const char*, const char*>& csm) noexcept
{
  return {csm.first, csm.second};
}
// Converts a valid std::ssub_match to a std::string_view.
constexpr std::string_view SMToSV(  //
...
constexpr std::wstring_view SMToSV(const std::pair<const wchar_t*, const wchar_t*>& wcsm) noexcept
{
  return {wcsm.first, wcsm.second};
}
// Converts a valid std::wssub_match to a std::wstring_view.
constexpr std::wstring_view SMToSV(  //
